...
export const mockJobs = [
  {
    ...
    progress: 100,
    files: [
      { id: 'file-1', name: '構造図_A.pdf', size: 2048000, uploadedAt: '2025-11-20T10:00:00Z' },
      { id: 'file-2', name: '施工図_A.pdf', size: 3072000, uploadedAt: '2025-11-20T10:01:00Z' },
    ],
  ...
  },
  {
    ...
    progress: 65,
    files: [
      { id: 'file-3', name: '組立図_B.pdf', size: 4096000, uploadedAt: '2025-11-20T09:30:00Z' },
    ],
  ...
  },
  {
    ...
    progress: 0,
    files: [
      { id: 'file-4', name: '構造図_C.pdf', size: 1024000, uploadedAt: '2025-11-20T07:00:00Z' },
    ],
  ...
  },
  {
    ...
    progress: 0,
    files: [
      { id: 'file-5', name: '組立図_D_破損.pdf', size: 512000, uploadedAt: '2025-11-19T14:00:00Z' },
    ],
...
export const mockInspectionResults = [
  ...
  },
  {
    ...
    aiJudgment: 'NG',
    confidence: 0.85,
    aiComment: '窓の位置が構造図と異なります',
    userAction: 'needs_fix',
    userComment: '要修正。施工図の開口部位置を調整',
    evidenceFile: 'file-2',
    evidencePage: 2,
